...
g="\033[1;92m"
r="\033[1;91m"
url_izin="https://raw.githubusercontent.com/ghoibvpnstore/izinsc/main/ip"
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mWhatsapp${NC} wa.me/6287865640750"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
checking_sc
REPO="https://raw.githubusercontent.com/ghoibvpnstore/vvip/main/bot/"
NS=$( cat /etc/xray/dns )
